...
class Product(models.Model):
    ...
    old_price = models.DecimalField(null=False, max_digits=5, decimal_places=0)
    new_price = models.DecimalField(null=True, blank=True, max_digits=5, decimal_places=0)
