...
<p>Этот проект представляет из себя простой интернет магазин. Здесь доступны следующие функции:<br>
-авторизации-регистрация<br>
-сброс пароля, с отправкой инструкций на почту<br>
-редактирование личного кабинета<br>
-просмотр товаров<br>
-добавление товаров в корзину, также смена количества и их удаление<br>
-оформление заказа, после подтверждения заказа приходит уведомление на почту клиента<br>
-просмотр всех своих заказов<br>
-возможность оставлять оценку и отзыв к заказанному товару<br>
</p>

<p>В проекте имеется 7 приложений: market, product, users, basket, orders, reviews, apiload.
</p>

<p>Струкутра базы данных</p>
<img src="content/database.png">
